...
import { saveTestimonialApplication } from "./actions";
...
export default function TestimonialApplyPage() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    const result = await saveTestimonialApplication(formData);

    if (result.success) {
      toast({
        title: "আবেদন সফল হয়েছে",
        description: "আপনার প্রশংসাপত্রের আবেদন সফলভাবে জমা দেওয়া হয়েছে।",
      });
      reset();
    } else {
      toast({
    ...
    <div className="bg-white py-16">
      <div className="container mx-auto px-4 max-w-2xl">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-primary font-headline">প্রশংসাপত্রের জন্য আবেদন</h1>
